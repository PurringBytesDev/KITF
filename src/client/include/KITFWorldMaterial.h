/*
-----------------------------------------------------------------------------
Filename:    KITFWorldMaterial.h
-----------------------------------------------------------------------------
This handle any new terrain materials, is partly a generator
(c) KITF derivated work from Impressive Title by KOLVULKD

KITF is public domain, see readme file.
*/

// This derivate from OgreTerrainMaterial (analysed live on twitrch 27 june 2025)
#pragma once
...
namespace Ogre
{
	...
	*/
	class KITFWorldMaterial : public TerrainMaterialGenerator
	{
	public:
		KITFWorldMaterial();
		~KITFWorldMaterial();
