...
void MagixCollisionManager::createCollision(SceneNode *node, const Real &range, const Vector3 &force, const Vector3 &offset, const short &hp, const unsigned char &alliance, bool hitAlly)
{
	Collision tColl;
	tColl.mNode = node;
	tColl.offset = offset;
...
// this is clearly a world util function !!!
...
// same !!!
// site node : not feeding another vector3 to this exactly ? HUH ? WASTE OF POINTERS (we could ignore Y)
...
// This is an util, we shall revise physics
